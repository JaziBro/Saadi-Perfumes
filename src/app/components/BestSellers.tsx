...
import { addToCart } from '../components/cart/cartSlice'; // Adjust import path as needed
import Image from "next/image";
import perfume1 from "../../../public/images/perfumes/perfume-4.jpg";
import perfume2 from "../../../public/images/perfumes/perfume-5.jpg";
import perfume3 from "../../../public/images/perfumes/perfume-6.jpg";
...
export default function BestSellers() {
  ...
  const perfumes = [
    { id: '126', image: perfume1, name: "EDEN", price: "Rs.3,750", reviews: "718 reviews", rating: rating },
    { id: '127', image: perfume2, name: "ECHO", price: "Rs.4,250", reviews: "850 reviews", rating: rating },
    { id: '128', image: perfume3, name: "SERENE", price: "Rs.3,990", reviews: "623 reviews", rating: rating },
  ...
  return (
    <div className="text-center py-4">
      <div className="text-xl font-bold text-black">BEST SELLERS</div>
